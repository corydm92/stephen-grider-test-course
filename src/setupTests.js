 ...
 * @Shallow - Render *just* the given component and none of its children (used when we want to test a component in isolation, and not when we want to test components underneath it)
