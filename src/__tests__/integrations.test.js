...
it('can fetch a list of comments and display them', (done) => {
	...
	setTimeout(() => {
		wrapper.update(); // Remember, when there are changes to JSDOM we may need to update the wrapper to see those changes. This is an example of where update() is needed.
